...
- (void)getSMSCode{
	RMCommonTimer *timerInstance = [RMCommonTimer sharedInstance];
	[timerInstance resumeTimerWithDuration:60 interval:1];
	timerInstance.handleBlock = ^(NSInteger currentTime) {
		//倒计时页面处理
